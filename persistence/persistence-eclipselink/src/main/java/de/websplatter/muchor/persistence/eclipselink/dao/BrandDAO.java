...
import de.websplatter.muchor.persistence.eclipselink.entity.Brand;
 ...
 */
@ApplicationScoped
public class BrandDAO extends de.websplatter.muchor.persistence.dao.BrandDAO {
  ...
  @Override
  public de.websplatter.muchor.persistence.entity.Brand findByKey(String key) {
